...
export function HeroSection() {
  return (
    <section className="relative pt-20 pb-20 lg:pt-32 lg:pb-28 overflow-hidden bg-gradient-to-b from-blue-50/50 via-white to-white">
      ...
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-72 h-72 bg-sky-100 rounded-full blur-3xl opacity-50"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/members" className="border border-slate-300 hover:border-blue-600 hover:text-blue-700 text-slate-600 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:bg-blue-50">
            Kenali Tim Kami
          </Link>
        </div>
      </div>
